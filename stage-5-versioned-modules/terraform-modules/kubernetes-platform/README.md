...
| | |
| --- | --- |
| Current release | `kubernetes-platform/v5.1.0` |
...
creates nothing. It asserts the things a consumer is entitled to rely on: audit
logging is on, the default node group has a floor of two, and a single-subnet
